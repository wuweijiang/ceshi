...
person.prototype={
    draw:function () {
        ...
        this.cobj.drawImage(this[this.status][this.state],0,0,82,88,0,0,this.width,this.height);
        this.cobj.restore();
...
finder.prototype={
    draw:function () {
        this.cobj.save();
        this.cobj.translate(this.x,this.y);
        this.cobj.drawImage(this.finder[this.state],0,0,80,80,0,0,this.width/1.5,this.height/1.5);
        this.cobj.restore();
    }
}
...
zidan.prototype = {
    draw:function () {
        ...
        this.cobj.save();
        this.cobj.translate(this.x,this.y);
        this.cobj.drawImage(this.zhi[this.state],0,0,188,100,0,0,this.width,this.height/2);
        this.cobj.restore();
    }
}
...
// 游戏主类
function game(canvas,cobj,run,jump,finder,zhi,lif,jifen,runa,hita,zidana,jumpa,hidea) {
    this.canvas=canvas;
    this.cobj=cobj;
    this.finder=finder;
    this.lif=lif;
